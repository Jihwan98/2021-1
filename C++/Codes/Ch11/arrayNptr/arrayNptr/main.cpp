...
int main() {
	...
	//cout << "ps1 = " << ps1 << endl;
	//cout << "ps2 = " << ps2 << endl;
	//cout << "ps2 - ps1 = " << ps2 - ps1 << endl;  // divided by sizeof(short) 8이 아니라 4가 나옴
	// 1. 배열명을 사용한 index 표현
	// 2. 배열명을 사용한 포인터 표현 // i의 2 제곱으로 초기화
	// 3. 배열명을 저장한 포인터 변수를 사용한 포인터 표현 // i의 3 제곱으로 초기화
	// 4. 배열명을 저장한 포인터 변수를 사용한 index 포현  // i의 4 제곱으로 초기화
	int A[10] = { -999 };
	int* p = A;
	...
	//cout << " 4. 배열명을 저장한 포인터 변수를 사용한 index 포현" << endl;
	//for (int i = 0; i < 10; i++) {
	...
	//int* q = &i;
	//cout << "q = " << q << endl;
	//cout << "++q = " << ++q << endl; // preincrement. 먼저 4만큼 증가하고 cout에게 전달
	//cout << "q = " << q << endl;
	//q = &i;
	//cout << "q = " << q << endl;
	//cout << "q++ = " << q++ << endl; // postincrement. cout에 값을 먼저 전달하고 4만큼 증가
	//cout << "q = " << q << endl;

	cout << " 3-1. postincrement 배열명을 저장한 포인터 변수를 사용한 포인터 표현" << endl;
	cout << "p = " << p << endl; // 가정 : p의 값이 FA54
	for (int i = 0; i < 10; i++) {
